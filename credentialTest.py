...
class TestCredentials(unittest.TestCase):
    def setUp(self):
        self.myCred = Credentials("facebook", "Aizo Murage", "megan")

    def test_Init_(self):
        self.assertEqual(self.myCred.account, "facebook")
        self.assertEqual(self.myCred.user_name, "Aizo Murage")
        self.assertEqual(self.myCred.pass_word, "megan")
    def tearDown(self):
        Credentials.creden_list = []
    def test_save_credentials(self):
        self.myCred.saveCred()
        test_cred = Credentials("facebook", "Aizo Murage", "megan")
        test_cred.saveCred()
